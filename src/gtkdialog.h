...
/* The most recently created radio tool button (used for grouping) */
extern GtkWidget *lasttoolradiowidget;
...
void gtkdialog_warning(const gchar *format, ...) G_GNUC_PRINTF(1, 2);
...
int gtkdialog_error(char *message);
